...
let VehicleStoreComponent = class VehicleStoreComponent {
    constructor(http, cdr, vehicleService) {
        this.http = http;
        this.cdr = cdr;
...
VehicleStoreComponent.ctorParameters = () => [
...
let VehicleStoreService = class VehicleStoreService {
...
VehicleStoreService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"] },
